...
<div class="hero">
  ...
  <div class="hero-actions">
    {% if site.app_store_url != "" %}<a href="{{ site.app_store_url }}" class="btn btn-primary" aria-label="Download CallPlan from App Store">
    ...
    <a href="/ai/" class="btn btn-secondary">KI-Funktionen</a>
  </div>
</div>
  ...
  <div class="download-container">
    ...
    <div class="download-actions">
      ...
      <div class="download-meta">
        <span class="rating">★★★★★ 4.8/5 (150 Bewertungen)</span>
        <span class="compatibility">iOS 15.0+ • CarPlay • Offline</span>
      </div>
    </div>
  </div>
</div>
...
<div class="driving-window">
  ...
  <div>
    ...
    <p>CallPlan erscheint auf deinem CarPlay-Display. Du siehst, wen du heute noch anrufen wolltest. Du rufst an. Du diktierst die Notizen mit Siri. CallPlan schickt sie automatisch weiter. Bevor du parkst, ist alles erledigt.</p>
  </div>
</div>
...
<div class="steps-row">
  ...
  <div class="step-card">
    ...
    <p>Schreib oder diktiere nach dem Gespräch – auch per Siri oder CarPlay, komplett freihändig.</p>
  </div>
  <div class="step-card">
