---
layout: default
title: CarPlay-Compatible Car Models – Current List
permalink: /en/carplay-models/
lang: en
lang_ref: carplay-models
description: "All CarPlay-compatible car models 2025/2026 – vehicles supported by Apple CarPlay. Check if your car is on the list."
---

<div class="hero" style="padding-bottom:0">
  <div class="hero-badge">CarPlay · Vehicles · Compatibility</div>
  <h1 class="hero-title">CarPlay-Compatible Vehicles 🚙</h1>
  <p class="hero-sub">Find a comprehensive overview of car models that support Apple CarPlay. From popular manufacturers to luxury brands – a complete list of compatible vehicles.</p>
</div>
...
1. **Check the owner's manual** – The most complete way is to check your vehicle's documentation
2. **Manufacturer's website** – Visit your car manufacturer's official site for specifications
3. **Test in your car** – Connect your iPhone via USB cable to the infotainment system and see if CarPlay appears
4. **Apple's official list** – Apple maintains an updated list of all compatible vehicles at <a href="https://support.apple.com/en-us/HT204084" target="_blank" rel="noopener">support.apple.com</a>.
...
<a href="{{ site.app_store_url }}" target="_blank" rel="noopener" class="btn btn-primary" style="display: inline-block; margin-top: 1rem;">Download CallPlan Now</a>
...
*This list is updated regularly. Last updated: {{ "now" | date: "%B %Y" }}*
